...
#加血
execute if score taskmode config matches 1 if score 5 count matches ..10 run scoreboard players add 5 count 1
execute if score taskmode config matches 1 run function dontr:team5/pls
