...
execute if score taskmode config matches 0 run scoreboard players remove 4 count 1
execute if score taskmode config matches 0 run scoreboard players remove 5 count 1

#加血
execute if score taskmode config matches 1 if score 3 count matches ..10 run scoreboard players add 3 count 1
execute if score taskmode config matches 1 run function dontr:team3/pls
...
execute if score taskmode config matches 0 run scoreboard players remove 4 dr 1
...
execute if score taskmode config matches 0 run execute if entity @e[team=4,gamemode=survival] run function dontr:team4/pls
