...
#加血
execute if score taskmode config matches 1 if score 1 count matches ..10 run scoreboard players add 1 count 1
execute if score taskmode config matches 1 run function dontr:team1/pls
