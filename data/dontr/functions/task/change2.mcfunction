...
#加血
execute if score taskmode config matches 1 if score 2 count matches ..10 run scoreboard players add 2 count 1
execute if score taskmode config matches 1 run function dontr:team2/pls
